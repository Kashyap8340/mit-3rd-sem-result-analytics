...
import { BRANCH_DATA, generateRegistrationNumbers } from "@/lib/utils";
...
export function ResultDashboard() {
    ...
    const handleFetch = async () => {
        ...
        const regNos = generateRegistrationNumbers(branch.code, branch.count);
        ...
        for (let i = 0; i < total; i += BATCH_SIZE) {
            ...
            const promises = batch.map((regNo) => fetchStudentResult(regNo));
    ...
    return (
        <div className="space-y-8">
            <Card className="border-2 shadow-sm hover:shadow-md transition-shadow duration-300">
                ...
                <CardContent className="pt-6 flex flex-col gap-6 sm:flex-row sm:items-end">
